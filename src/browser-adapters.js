...
export const BROWSER_SOURCE_ADAPTERS = Object.freeze({
  ...
  vietdom: adapter('vietdom', ['vietdom.com'], '/ar', {
    availabilityFallback: 'not stated on source card',
    cards: '.js-product.t-store__card[data-product-uid]',
    details: 'main, .t-store__product',
    fields: {
      contact: '.t-store__card__btn-text',
      description: '.t-store__card__descr',
      location: '.t-store__card__descr',
      metadata: '.t-store__card__btn-text',
      price: '.t-store__card__price',
    },
    identityAttributes: ['data-product-uid'],
    link: 'a[href*="/tproduct/"]',
    media: '.t-store__card__bgimg',
    title: '.t-store__card__title',
  }),
